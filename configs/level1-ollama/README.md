...
- **un.sh**: Linux/Mac環境でModelfileからカスタムモデル qwen-processor を自動作成するスクリプト。
...
> Windows では localhost:11434 が接続拒否される場合があるため、Open WebUI の管理者設定（または環境変数 OLLAMA_BASE_URL）を http://127.0.0.1:11434 に指定してください。
